Download the zip file, extract it, then go to Mandelbrot/src and double click mandelbrot.exe to run the program, or better yet, run it with vscode with a compiler(configure compiler path in .vscode)
