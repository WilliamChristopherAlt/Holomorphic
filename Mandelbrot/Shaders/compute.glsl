...
void main()
{
	...
	while(i < maxIter)
	{
		...
		// Be creative and invent your own holomorphic function here to viualize it's dynamics!
		...
		// Phoenix
		z = multC(z, z) + z0 + multC(multC(selectedPoints[0], zp), selectedPoints[1]);
		
		// Saving the previous z
		zp = zt;
